...
//        }else {
//			Log.i("DDDDDDD", "text = " + etPictureTagLabel.getText().toString());
//		}
	...
	protected void initViews(){
		LayoutInflater.from(context).inflate(R.layout.user_main_image_picturetagview, this,true);
	...
	public void setStatus(Status status){
		...
		case Normal:
			...
			if (etPictureTagLabel.getText().toString().equals("")||etPictureTagLabel.getText().toString().equals("标签"))
			{
				...
				image_history.Label = etPictureTagLabel.getText().toString();
				Image.Label = etPictureTagLabel.getText().toString();
				Log.i("DDDDDDD", "text2 = " + etPictureTagLabel.getText().toString());
			}
