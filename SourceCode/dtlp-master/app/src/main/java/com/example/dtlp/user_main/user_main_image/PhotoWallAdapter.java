...
import com.example.dtlp.user_main.user_main_image.DiskLruCache.Snapshot;
...
//		Bitmap bb = decodeImageFile()

//            Bitmap b = decodeImageFile(f, 1280, 720);


//		BitmapFactory.Options options = new BitmapFactory.Options();
//		options.inSampleSize = 8; Bitmap bm = BitmapFactory.decodeFile(img,options);
//		imageView.setImageBitmap(bm);
	}

	public static Bitmap decodeImageFile(FileInputStream ff, int WIDTH, int HIGHT) {
//		try {
			//Decode image size
			BitmapFactory.Options o = new BitmapFactory.Options();
			o.inJustDecodeBounds = true;
			BitmapFactory.decodeStream(ff, null, o);
			...
			return BitmapFactory.decodeStream(ff, null, o2);
...
//		return null;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			view = LayoutInflater.from(getContext()).inflate(R.layout.user_main_push_image, null);
		}
		else {
			view = convertView;
		}
	...
	class BitmapWorkerTask extends AsyncTask<String, Void, Bitmap> {
		...
		protected Bitmap doInBackground(String... params) {
			...
			try {
				...
				// 将缓存数据解析成Bitmap对象
//				Bitmap bitmap = decodeImageFile(fileInputStream,1280, 720);
				Bitmap bitmap = null;
