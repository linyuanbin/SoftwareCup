package com.example.dtlp.tap_fragment.fragment_push_image;
...
import com.example.dtlp.tap_fragment.fragment_push_image.utility.ImageLoader;
...
//    public ImageLoader mImagerLoader;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.user_main_push_image, null);
            holder.iv = (ImageView) convertView.findViewById(R.id.id_photo);
