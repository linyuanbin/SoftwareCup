package com.example.dtlp.tap_fragment.fragment_push_image.utility;
...
public final class DiskLruCacheUtil {
	...
	public DiskLruCache doOpen() {
		...
		try {
			...
			// 创建一个DiskLruCache的实例
//			diskLruCache = new DiskLruCache(cacheDir, getAppVersion(context), 1, 100 * 1024 * 1024);
//			diskLruCache.open(cacheDir, getAppVersion(context), 1, 100 * 1024 * 1024);
