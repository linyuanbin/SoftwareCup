package com.example.dtlp.tap_fragment.frament_search_image;
...
public class PhotosWallAdapterSearch extends BaseAdapter {
    ...
    public PhotosWallAdapterSearch(Context context, List<String> data, AbsListView absListView) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.user_main_search_image, null);
            holder.iv = (ImageView) convertView.findViewById(R.id.search_id_photo);
